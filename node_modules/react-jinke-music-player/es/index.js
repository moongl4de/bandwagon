...
var ReactJkMusicPlayer = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(ReactJkMusicPlayer, [{
    ...
    get: function get() {
      ...
      return locale ? _objectSpread({}, LOCALE_CONFIG[LOCALE.en_US], {}, locale) : {};
    }
  }]);
  ...
  _createClass(ReactJkMusicPlayer, [{
    ...
    value: function render() {
      ...
      var _currentTime = formatTime(currentTime);

      var _duration = formatTime(duration);
      ...
      }, !drag || toggle ? _defineProperty({}, IS_MOBILE ? "onTouchStart" : "onClick", this.onDestroyPlayer) : null), /*#__PURE__*/React.createElement(CloseIcon, null));
      ...
      return createPortal( /*#__PURE__*/React.createElement("div", {
      ...
      }, toggle && isMobile && /*#__PURE__*/React.createElement(AudioPlayerMobile, {
        playing: playing,
        loading: loading,
        pause: pause,
        name: name,
      ...
      }, AudioController) : AudioController, toggle && !isMobile && /*#__PURE__*/React.createElement("div", {
      ...
      }, loading ? "--" : _currentTime), /*#__PURE__*/React.createElement("div", {
        ...
        className: "duration"
      }, loading ? "--" : _duration))), /*#__PURE__*/React.createElement("div", {
      ...
      }, isMute ? /*#__PURE__*/React.createElement("span", _extends({
      ...
      }), /*#__PURE__*/React.createElement(FaMinusSquareOIcon, null)), DestroyComponent)), /*#__PURE__*/React.createElement(PlayModel, {
        visible: playModelNameVisible,
        value: currentPlayModeName
      })), /*#__PURE__*/React.createElement(AudioListsPanel, {
        playId: playId,
        pause: pause,
